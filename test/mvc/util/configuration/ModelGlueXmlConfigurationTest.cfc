component asyncAll="false" labels="list" skip="false"{
    ...
    public void function testConstructor(){
        ...
        _configurations = {
            ...
            reloadKey="init",
            reloadPassword="true",
            configurationClass="mvc.util.configuration.ModelGlueXmlConfiguration",
            configurationXml="config/ModelGlue.xml",
        ...
        var conf = new mvc.util.configuration.ModelGlueXmlConfiguration( fw );
